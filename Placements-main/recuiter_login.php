...
$password=$_POST['password'];
 ...
 $query= "select * from  recruiter  where rid='$username' and rpw='$password'";
...
//  $counter2=mysqli_num_rows($result2);
 ...
 if($counter!=0)
 {
    ...
    $_SESSION['rid']=$details['rid'];
    $_SESSION['rname']=$details['rname'];
   ...
   //  $queryrank="SELECT @r:=@r+1 as Rank,sid FROM exam_totals JOIN (SELECT @r:=0 from DUAL) as sub ORDER BY TOTAL DESC";
    ...
    echo" <script>document.location='recuiter-dashboard.php'</script>";
...
<div class="loginbox">
 <div class="login-left"> 
  <img class="img-fluid" src="assets/img/recruiter.png" alt=""> 
</div> 
...
<input class="form-control" type="text" name="rid" placeholder="user name">
</div>
<div class="form-group">
