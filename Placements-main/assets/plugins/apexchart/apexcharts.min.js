          ...
          return a(t, [{
              ...
              value: function(t, e) {
                  ...
                  if (this.annoCtx.invertAxis) {
                      ...
                      var o;
                      if (s.config.yaxis[e.yAxisIndex].logarithmic) o = (a = new w(this.annoCtx.ctx).getLogVal(a, e.yAxisIndex)) / s.globals.yLogRatio[e.yAxisIndex];
  ...
  var S = {
              ...
              value: function(t, e, i, a, s, r, n) {
                  ...
                  if (o.globals.dataChanged)
                      if (this.dynamicAnim) {
                          ...
                          for (var z = 0; z < o.globals.collapsedSeries.length; z++) o.globals.collapsedSeries[z].index === s && (L = 1, a = 0);
      ...
      O = function() {
          ...
          return a(t, [{
              ...
              value: function(t) {
                  for (var e = this, i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.ctx, a = this.w.config, s = this.w.globals, r = new y(i), n = a.labels.length > 0 ? a.labels.slice() : a.xaxis.categories.slice(), o = function() {
                      ...
                      var r = new R({}),
                          n = function() {
                              ...
                              if (n > a) {
                                  ...
                                  for (var l = 0; l < s.length; l++) n < s[l].breakpoint && (t = w.extendArrayProps(r, s[l].options, i), t = f.extend(i.config, t), e.overrideResponsiveOptions(t))
                          };
                      if (t) {
          ...
          return a(t, [{
              ...
              value: function(t) {
                  ...
                  for (var p = function(t, r) {
                      ...
                      }, x = 0, b = h.globals.series.length - 1; x < h.globals.series.length; x++, b--) p(x, b)
              }
          }, {
              key: "getFormatters",
              value: function(t) {
  ...
  window.TreemapSquared = {}, window.TreemapSquared.generate = function() {
      function t(e, i, a, r) {
          this.xoffset = e, this.yoffset = i, this.height = r, this.width = a, this.shortestEdge = function() {
              ...
              if (this.width >= this.height)
                  for (e = 0; e < t.length; e++) i.push([a, r, a + n, r + t[e] / n]), r += t[e] / n;
              else
                  for (e = 0; e < t.length; e++) i.push([a, r, a + t[e] / o, r + o]), a += t[e] / o;
              return i
      ...
      function e(e, a, r, n, o) {
          return n = void 0 === n ? 0 : n, o = void 0 === o ? 0 : o,
              function(t) {
                  ...
                  var o, l, h;
                  if (0 !== e.length) return o = r.shortestEdge(), l = e[0],
                      function(t, e, a) {
                          var s;
      ...
      return function t(i, s, n, o, l) {
          ...
          var h, c, d = [],
              g = [];
          if (a(i[0])) {
              for (c = 0; c < i.length; c++) d[c] = r(i[c]);
              for (h = e(d, s, n, o, l), c = 0; c < i.length; c++) g.push(t(i[c], h[c][2] - h[c][0], h[c][3] - h[c][1], h[c][0], h[c][1]))
          } else g = e(i, s, n, o, l);
          return g
      }
  }();
              ...
              value: function(t, e) {
                  ...
                  if (s.comboCharts) {
                      ...
                      case "bar":
                          ...
                          else p = new Y(this.ctx, e).draw(s.series);
                          break;
                      case "candlestick":
                  ...
                  case "A":
                      t = (e = function(t, e) {
                          var i, a, s, r, n, o, l, h, c, d, g, u, f, p, x, b, m, v, y, w, k, A, S, C, L, P, T = Math.abs(e[1]),
                              ...
                              D = new SVG.Point(X, Y),
                              R = [];
                          if (0 === T || 0 === z || F.x === D.x && F.y === D.y) return [
                          ...
                          for (k = 1, A = b.length; k < A; k++) w = b[k - 1][2], S = w.x, C = w.y, w = b[k][0], L = w.x, P = w.y, w = b[k][1], X = w.x, Y = w.y, R.push(["C", S, C, L, P, X, Y]);
                          return R
                      }(this.pos, t))[0]
              }
