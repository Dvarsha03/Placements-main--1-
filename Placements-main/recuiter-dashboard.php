...
<a href="#"><i class="fas fa-users"></i> <span> Dashboard</span> <span class="menu-arrow"></span></a>
<ul>
<li><a href="recuiter-dashboard.php" class="active">Recuiter Dashboard</a></li>
</ul>
</li>
<li class="submenu">
<a href="#"><i class="fas fa-university"></i> <span> Universities </span></a>
<!-- <ul>
...
<div class="row">
<div class="col-sm-12">
<h3 class="page-title">Welcome <?php echo $_SESSION['rname'];?>!</h3>
<ul class="breadcrumb">
<li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
<li class="breadcrumb-item active">Recuiter Dashboard</li>
</ul>
</div>
</div>
</div>
...
<div class="row align-items-center">
<div class="col-6">
<h5 class="card-title">Skill Graph</h5>
</div>
<div class="col-6">
...
<div class="card flex-fill">
<div class="card-header">
<h5 class="card-title">Class Decorum</h5>
</div>
<div class="card-body">
<div class="col-6 col-lg6 col-xl-8 dash-widget2">
<div class="card-body">
